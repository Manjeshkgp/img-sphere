...
const styles = {
  ...
  tag:"flex justify-center items-center text-center px-[7.1px] bg-[#F5F5F5] dark:bg-slate-900 text-[#767676] dark:text-[#F5F5F5] font-helvetica_neue text-[11.54px] leading-[200%] rounded-[1.78px] border-none"
};
