...
const styles = {
  ...
  secondary: "w-[151.136px] h-[42.47px] flex justify-center items-center rounded border border-[#D1D1D1] text-center font-helvetica_neue text-[13.74px] leading-[14.797px] text-[#767676] font-medium capitalize",
